...
TEST(MRBayesTree, clique_edge) {
  ...
  EXPECT(ContainerEqual<GaussianMRBayesTree::EdgeVector>(expected_parent_c1,
                                                         c1->parentEdges()));
  EXPECT(ContainerEqual<GaussianMRBayesTree::EdgeVector>(expected_child_c1,
                                                         c1->childEdges()));
  EXPECT(ContainerEqual<GaussianMRBayesTree::EdgeVector>(expected_parent_c2,
                                                         c2->parentEdges()));
  EXPECT(ContainerEqual<GaussianMRBayesTree::EdgeVector>(expected_child_c2,
                                                         c2->childEdges()));
  EXPECT(ContainerEqual<GaussianMRBayesTree::EdgeVector>(expected_parent_c3,
                                                         c3->parentEdges()));
  EXPECT(ContainerEqual<GaussianMRBayesTree::EdgeVector>(expected_child_c3,
                                                         c3->childEdges()));
  ...
  EXPECT(ContainerEqual<GaussianMRBayesTree::CliqueVector>(
      expected_parent_cliques_c1, c1->parentCliques()));
  EXPECT(ContainerEqual<GaussianMRBayesTree::CliqueVector>(
      expected_parent_cliques_c2, c2->parentCliques()));
  EXPECT(ContainerEqual<GaussianMRBayesTree::CliqueVector>(
      expected_child_cliques_c1, c1->childCliques()));
  EXPECT(ContainerEqual<GaussianMRBayesTree::CliqueVector>(
      expected_child_cliques_c2, c2->childCliques()));
  ...
  EXPECT(ContainerEqual<GaussianMRBayesTree::CliqueVector>(
      expected_neighbor_c1, c1->neighborCliques()));
  EXPECT(ContainerEqual<GaussianMRBayesTree::CliqueVector>(
      expected_neighbor_c2, c2->neighborCliques()));
  EXPECT(ContainerEqual<GaussianMRBayesTree::CliqueVector>(
      expected_neighbor_c3, c3->neighborCliques()));
  ...
  graph += JacobianFactor(1, 1.0 * I_1x1, Vector1(0.0), model),
  ...
  EXPECT(
      ContainerEqual<GaussianFactorGraph>(expected_elim_factors, elim_factors));
  ...
  EXPECT(ContainerEqual<GaussianFactorGraph>(expected_factors_in_c2,
                                             factors_in_c2));
}
...
TEST(MRBayesTree, Constructor) {
  ...
  mrbt.computeDelta(root_clique, root_clique, graph, VariableIndex(graph),
                    delta);
...
TEST(MRBayesTree, ToyExample) {
  ...
  graph += JacobianFactor(a0, 1.0 * I_1x1, Vector1(0.0), model),
